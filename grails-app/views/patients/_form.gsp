...
<div class="fieldcontain ${hasErrors(bean: patientsInstance, field: 'assura', 'error')} ">
	...
	<g:select name="assura" from="${project_test.Assurance.list()}" multiple="multiple" optionKey="id" size="5" value="${patientsInstance?.assura*.id}" class="many-to-many"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: patientsInstance, field: 'medecins', 'error')} ">
	...
	<g:select name="medecins" from="${project_test.Medecins.list()}" multiple="multiple" optionKey="id" size="5" value="${patientsInstance?.medecins*.id}" class="many-to-many"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: patientsInstance, field: 'medi', 'error')} ">
	...
	<g:select name="medi" from="${project_test.Medicaments.list()}" multiple="multiple" optionKey="id" size="5" value="${patientsInstance?.medi*.id}" class="many-to-many"/>
</div>
