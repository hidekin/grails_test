	...
	<body>
		...
		<div id="show-issue" class="content scaffold-show" role="main">
			...
			<ol class="property-list issue">
				...
				<g:if test="${issueInstance?.priority}">
				<li class="fieldcontain">
					<span id="priority-label" class="property-label"><g:message code="issue.priority.label" default="Priority" /></span>
					
						<span class="property-value" aria-labelledby="priority-label"><g:fieldValue bean="${issueInstance}" field="priority"/></span>
